...
# Training a model using multiple different algorithms and comparing the results
...
plt.savefig(f'plots/ML/all_features_real_prediction.png')
plt.close()
...
plt.ylabel('Deviance')
plt.savefig(f'plots/ML/all_features_deviance.png')
plt.close()
...
plt.savefig(f'plots/ML/all_features_featuresImportance.png')
plt.close()
...
plt.xlabel('Real Value')
plt.ylabel('Predicted Value')
plt.savefig(f'plots/ML/Without_G2_real_prediction.png')
plt.close()
...
plt.xlabel('Boosting Iterations')
plt.ylabel('Deviance')
plt.savefig(f'plots/ML/Without_G2_deviance.png')
plt.close()
...
(pd.Series(clf.feature_importances_, index=X.columns)
 ...
 .plot(kind='barh'))
plt.title('Variable Importance')
plt.savefig(f'plots/ML/Without_G2_featureImportance.png')
plt.close()
...
plt.xlabel('Real Value')
plt.ylabel('Predicted Value')
plt.savefig(f'plots/ML/Without_G1G2_real_prediction.png')
plt.close()
...
plt.xlabel('Boosting Iterations')
plt.ylabel('Deviance')
plt.savefig(f'plots/ML/Without_G1G2_deviance.png')
plt.close()
...
plt.title('Variable Importance')
plt.savefig(f'plots/ML/Without_G1G2_featureImportance.png')
plt.close()
...
# Splitting features and target data sets into: train and test
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.35)
...
plt.xlabel('Real Value')
plt.ylabel('Predicted Value')
plt.savefig(f'plots/ML/only_G1G2_real_prediction.png')
plt.close()
...
plt.xlabel('Boosting Iterations')
plt.ylabel('Deviance')
plt.savefig(f'plots/ML/only_G1G2_deviance.png')
plt.close()
...
plt.title('Variable Importance')
plt.savefig(f'plots/ML/only_G1G2_featureImportance.png')
plt.close()
